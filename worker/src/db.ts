...
export async function upsertEvent(
  ...
  await db.prepare(`
    ...
    ON CONFLICT(id) DO UPDATE SET
      ...
      category      = CASE WHEN excluded.category = 'Other' THEN events.category ELSE excluded.category END,
      tags          = excluded.tags,
    ...
    const stmts = chunk.map(e =>
      db.prepare(`
        ...
        ON CONFLICT(id) DO UPDATE SET
          ...
          category = CASE WHEN excluded.category = 'Other' THEN events.category ELSE excluded.category END, tags = excluded.tags,
          price_type = excluded.price_type,
